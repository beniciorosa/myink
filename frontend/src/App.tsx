                    ...
                    {state === AppState.IDLE && (
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                                Refine seu <span className="text-blue-600 dark:text-blue-400">pensamento</span> crítico.
                            </h2>
                            <p className="text-sm md:text-base text-gray-500 dark:text-gray-400 mb-10 max-w-xl mx-auto leading-relaxed">
                                Destile os conceitos mais profundos de qualquer obra literária em segundos com IA avançada.
                            </p>
